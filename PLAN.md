...
- **TERMINAL T-L4 araç onayı — Astra 2095/2096 (`7e0e349`, 2026-09-26): 2092 R1–R2 kapandı; kalan P2 yerelde düzeltildi, yeniden inceleme bekliyor.** Başlangıç süpürmesi artık gözlem callback'inden bağımsız çalışıyor; gerçek servis yeniden başlatması üç kipte (gözlemli, gözlemsiz, anahtar yok → hiçbir şey kapanmaz ve raporlanır, anahtar oluşturulmaz) doğrulandı; mutasyon 7 (süpürme callback argümanında) gözlemsiz testi düşürüyor. Tam verify push öncesi.
