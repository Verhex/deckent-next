...
export class AttemptStoreError extends Error {
  constructor(readonly code: 'ATTEMPT_STORE_CONFLICT' | 'ATTEMPT_COMMAND_CONFLICT' | 'ATTEMPT_STORE_VERSION' | 'LEDGER_RESET_REQUIRED' | 'LEDGER_MIGRATION_EVIDENCE_REQUIRED' | 'ATTEMPT_STORE_CORRUPT' | 'ATTEMPT_STORE_BUSY' | 'ATTEMPT_STORE_OPTIONS' | 'ATTEMPT_STORE_OUTCOME_UNKNOWN' | 'ATTEMPT_STORE_READ_UNAVAILABLE') {
