...
export const dispatchRecordSchema = claimObject.extend({ schemaVersion: z.literal(1), terminal: dispatchTerminalSchema.nullable(), output: artifactReceiptSchema.optional() }).strict().readonly();
