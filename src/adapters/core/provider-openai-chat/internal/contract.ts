...
export type OpenAiChatHttpErrorCode = 'OPENAI_CHAT_DEFINITION_INVALID' | 'OPENAI_CHAT_REQUEST_INVALID'
  ...
  | 'OPENAI_CHAT_CANCELLED' | 'OPENAI_CHAT_TRANSPORT_UNKNOWN' | 'OPENAI_CHAT_REDIRECT_UNKNOWN'
  | 'OPENAI_CHAT_HTTP_UNKNOWN' | 'OPENAI_CHAT_RESPONSE_INVALID' | 'OPENAI_CHAT_MODEL_MISMATCH';
