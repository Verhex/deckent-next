...
export async function executeConfiguredRuntimeOperation(projectRoot: string, request: RuntimeServiceRequest,
  ...
  } satisfies Record<Exclude<RuntimeServiceOperation, 'describeService' | 'shutdownService' | 'invokeModel' | 'inspectModelInvocation' | 'purgeModelInvocationContent' | 'cancelModelInvocation'>, RuntimeOperationHandler>;
