...
import { createConfiguredRuntimeClient, invokeRuntimeModel, inspectRuntimeModelInvocation } from '#composition/core/runtime-service/index.js';
...
export async function main(argv: readonly string[] = process.argv.slice(2)) {
  ...
  try { return await runCli(argv, { initialize: registerProviderConfig, root, signal: controller.signal, startRuntimeService: startConfiguredCliRuntimeService,
    ...
    invokeModel: invokeRuntimeModel, inspectModelInvocation: inspectRuntimeModelInvocation,
