#!/usr/bin/env node
import { inspectConfiguredRun, requestConfiguredRunCancellation } from '#composition/core/runs/index.js';
...
export function main(argv: readonly string[] = process.argv.slice(2)) {
  return runCli(argv, { initialize: registerProviderConfig, inspectInventory: inspectConfiguredInventory, inspectRun: inspectConfiguredRun, requestRunCancellation: requestConfiguredRunCancellation });
}
