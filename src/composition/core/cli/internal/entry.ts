#!/usr/bin/env node
import { inspectConfiguredRun, deliverConfiguredRunCancellation } from '#composition/core/runs/index.js';
...
export function main(argv: readonly string[] = process.argv.slice(2)) {
  return runCli(argv, { initialize: registerProviderConfig, inspectInventory: inspectConfiguredInventory, inspectRun: inspectConfiguredRun, deliverRunCancellation: deliverConfiguredRunCancellation });
}
