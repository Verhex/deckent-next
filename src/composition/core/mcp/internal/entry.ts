...
export async function main(root = process.cwd()) {
  ...
  return serveStdio(() => createMcpServer({ requestRunCancellation: command => requestConfiguredRunCancellation(root, command), inspectRun: query => inspectConfiguredRun(root, query),
