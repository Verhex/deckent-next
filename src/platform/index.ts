...
export { resolveDeckentHome, resolveProductPaths } from '#platform/core/host/index.js';
...
export { inspectProductPaths, type ProductPathInspection } from '#platform/core/host/index.js';
